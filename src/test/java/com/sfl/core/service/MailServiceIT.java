...
public class MailServiceIT {
    ...
    public void testSendEmail() throws Exception {
        mailService.sendEmail(EMAIL, TEST_SUBJECT, TEST_CONTENT, false, false);
    ...
    public void testSendHtmlEmail() throws Exception {
        mailService.sendEmail(EMAIL, TEST_SUBJECT, TEST_CONTENT, false, true);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        assertThat(message.getSubject()).isEqualTo(TEST_SUBJECT);
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(EMAIL);
        ...
        assertThat(message.getContent()).isInstanceOf(String.class);
        assertThat(message.getContent().toString()).isEqualTo(TEST_CONTENT);
        assertThat(message.getDataHandler().getContentType()).isEqualTo(CHARSET_UTF_8);
    }

    @Test
    public void testSendMultipartEmail() throws Exception {
        mailService.sendEmail(EMAIL, TEST_SUBJECT, TEST_CONTENT, true, false);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
    ...
    public void testSendMultipartHtmlEmail() throws Exception {
        mailService.sendEmail(EMAIL, TEST_SUBJECT, TEST_CONTENT, true, true);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        MimeMultipart mp = (MimeMultipart) message.getContent();
        MimeBodyPart part = (MimeBodyPart) ((MimeMultipart) mp.getBodyPart(0).getContent()).getBodyPart(0);
        ...
        assertThat(message.getContent()).isInstanceOf(Multipart.class);
        assertThat(aos.toString()).isEqualTo("\r\ntestContent");
        assertThat(part.getDataHandler().getContentType()).isEqualTo(CHARSET_UTF_8);
    }
    ...
    public void testSendEmailWithException() {
        ...
        mailService.sendEmail(EMAIL, TEST_SUBJECT, TEST_CONTENT, false, false);
        assertThat("suppress sonar").isEqualTo("suppress sonar");
    }
