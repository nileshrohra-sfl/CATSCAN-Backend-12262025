...
public class AuditResourceIT {
    ...
    public void setup() {
        ...
        AuditEventService auditEventService =
            new AuditEventService(auditEventRepository, jhipsterProperties);
    ...
    public void getAllAudits() throws Exception {
        ...
        // Get all the audits
        restAuditMockMvc.perform(get("/management/audits/event/{eventType}",auditEvent.getAuditEventType()))
