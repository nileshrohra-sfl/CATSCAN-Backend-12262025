...
import com.sfl.core.service.impl.AuditEventService;
...
public class AuditResource {
    ...
    public ResponseEntity<List<PersistentAuditEvent>> getAllByEntityType(Pageable pageable,
                                                                         @PathVariable String eventType) {
        Page<PersistentAuditEvent> page = auditEventService.findAll(pageable, eventType);
    ...
    public ResponseEntity<List<PersistentAuditEvent>> getByDates(
        ...
        Page<PersistentAuditEvent> page = auditEventService.findByDates(from, to, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
     ...
     */
    @GetMapping("/{id:.+}")
    public ResponseEntity<PersistentAuditEvent> get(@PathVariable Long id) {
